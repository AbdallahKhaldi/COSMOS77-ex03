...
Targets HW3 (exercise number = 3, ex03 repo URL). Field values come from the
...
--template <docx> --output ~/COSMOS77/HW3/COSMOS77-ex03.pdf --exercise-number 3``.
"""
...
_REPO_URL = "https://github.com/AbdallahKhaldi/COSMOS77-ex03"
_STUDENTS = (
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Generate the COSMOS77-ex03 cover PDF.")
    parser.add_argument("--template", required=True, type=Path)
    parser.add_argument("--output", required=True, type=Path)
    parser.add_argument("--self-score", type=int, default=85)
    parser.add_argument("--exercise-number", type=int, default=3)
